...
module RRSED
  module Galois
    describe Field do
      ...
      it "it should have proper primitive" do
      ...
      it "it should do trivial divs properly" do
      ...
      it "it should do divs properly" do
